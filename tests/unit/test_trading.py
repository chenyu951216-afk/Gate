...
from app.trading.risk import TradingRiskError, adaptive_operational_leverage, build_execution_plan, dynamic_position_notional, max_leverage_for_notional, notional_for_contract, partial_close_size
...
async def test_scan_refresh_cannot_tighten_initial_stop_immediately_after_fill():
    ...
    assert update["initial_stop_locked"] is True
