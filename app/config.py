...
class Settings(BaseSettings):
    ...
    initial_stop_lock_seconds: int = 1800
    scan_stop_min_profit_r: float = 0.75
    ...
    # Scan-time TP reconciliation is deliberately slower and one-way.  A
    # new 30m analysis may tighten an open target, but it must not chase an
    # unfilled target farther away on every scan.
    scan_tp_update_cooldown_seconds: int = 1800
    scan_tp_min_move_atr: float = 0.20
    scan_tp_min_profit_r: float = 1.0
