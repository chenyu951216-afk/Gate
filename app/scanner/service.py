        ...
        async with self._lock:
            ...
            try:
                ...
                if not dry_run:
                    ...
                    # the dashboard/API exposes the actual Bitget rejection or
                    # fill result.  Discord scan and order channels remain
                    # independent; order notifications are emitted only by
                    # TradingService for a newly opened position.
